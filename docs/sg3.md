...
_Item 1 (`replaceZines` → `mergeZines`, action removed) landed after 1.4.4. Item 3 (Playwright in CI) shipped in 1.4.3. Items 2, 4, and 5 remain — the live list is `sg.md`._
