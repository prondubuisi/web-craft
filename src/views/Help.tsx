...
const ENTRIES: { term: string; body: string; to?: string; go?: string }[] = [
  ...
  {
    term: 'drop',
    body: 'Publish. A heading and a picture is enough. Now, in a minute, or as a time capsule years out. After drop, the snapshot is the pass. Print the page from the drop modal; fold sheet lives on Preview. A sealed drop stays folded until the clock hits.',
    to: '/studio',
    go: 'Open the studio',
  },
  {
  ...
  {
    term: 'remix',
    body: 'Fork someone else’s issue and make it yours. Credit stays on the original. The cover remixes after hours without a handle. Seeded pages on the wall remix the same way so the originals stay.',
    to: '/explore',
    go: 'The stream',
  },
  {
