...
`docs/ARCHITECTURE_PLAN.md` Round 2 is that note. **§8–11 done:** Preview uses `useRemote`; remote+local merges use `useRemoteWithFallback`; editor undo/redo lives in `useHistory`; `useIssueSocial` has tests. Remaining: items 12–14.
