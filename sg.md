...
`docs/ARCHITECTURE_PLAN.md` Round 2 is that note. **§8–10 done:** Preview uses `useRemote`; remote+local merges use `useRemoteWithFallback`; editor undo/redo lives in `useHistory`. Remaining: items 11–14.
